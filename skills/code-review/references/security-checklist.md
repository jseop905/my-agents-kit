...
Quick reference for web application security. Use alongside the `code-review` skill (Security axis).
...
| 6 | Vulnerable Components | Dependency audits, keep deps updated, minimal deps |
